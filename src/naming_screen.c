...
static const u8 *const gRivalPresetNames[] = {
    gText_DefaultNameBarry,
    gText_DefaultNameNolan,
    gText_DefaultNameRoy,
    gText_DefaultNameGavin
};
...
void NameRival(void)
{
    StringCopy(gSaveBlock2Ptr->rivalName, gRivalPresetNames[Random() % NELEMS(gRivalPresetNames)]); // choose a random name from gRivalPresetNames for player's rival
