static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_SANDGEM_TOWN_1 - 1] = {MAP_GROUP(SANDGEM_TOWN), MAP_NUM(SANDGEM_TOWN), 13, 11},
    [HEAL_LOCATION_TWINLEAF_TOWN - 1] = {MAP_GROUP(TWINLEAF_TOWN), MAP_NUM(TWINLEAF_TOWN), 22, 21},
    [HEAL_LOCATION_SANDGEM_TOWN_2 - 1] = {MAP_GROUP(SANDGEM_TOWN), MAP_NUM(SANDGEM_TOWN), 13, 11},
    [HEAL_LOCATION_JUBILIFE_CITY - 1] = {MAP_GROUP(JUBILIFE_CITY), MAP_NUM(JUBILIFE_CITY), 63, 42},
    [HEAL_LOCATION_OREBURGH_CITY - 1] = {MAP_GROUP(OREBURGH_CITY), MAP_NUM(OREBURGH_CITY), 48, 24},
    [HEAL_LOCATION_FLOAROMA_TOWN - 1] = {MAP_GROUP(FLOAROMA_TOWN), MAP_NUM(FLOAROMA_TOWN), 16, 48},
    [HEAL_LOCATION_ETERNA_CITY - 1] = {MAP_GROUP(ETERNA_CITY), MAP_NUM(ETERNA_CITY), 15, 21},
};
