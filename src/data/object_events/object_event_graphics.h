...
const u32 gObjectEventPic_TM_Ball[] = INCBIN_U32("graphics/object_events/pics/misc/tm_ball.4bpp");
const u16 gObjectEventPal_TM_Ball[] = INCBIN_U16("graphics/object_events/palettes/tm_ball.gbapal");
