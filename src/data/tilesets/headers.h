...
const struct Tileset gTileset_Sinnoh =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_Sinnoh,
    .palettes = gTilesetPalettes_Sinnoh,
    .metatiles = gMetatiles_Sinnoh,
    .metatileAttributes = gMetatileAttributes_Sinnoh,
    .callback = InitTilesetAnim_Sinnoh,
};
...
const struct Tileset gTileset_Jubilife = 
{
    ...
    .callback = InitTilesetAnim_Jubilife,
};
...
const struct Tileset gTileset_Lakefront =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Lakefront,
    .palettes = gTilesetPalettes_Lakefront,
    .metatiles = gMetatiles_Lakefront,
    .metatileAttributes = gMetatileAttributes_Lakefront,
    .callback = NULL,
};
