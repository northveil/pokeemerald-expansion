...
#define FLAG_HIDE_RIVAL_PLAYER_ROOM    0x20 // Unused Flag
#define FLAG_CATCHING_TUTORIAL    0x21 // Unused Flag
...
#define FLAG_EXP_SHARE_FLAG   0x264 // Sets Whether the exp share is turned on
...
// Towns and Cities
#define FLAG_VISITED_LITTLEROOT_TOWN                (SYSTEM_FLAGS + 0xF) //twinleaf
#define FLAG_VISITED_OLDALE_TOWN                    (SYSTEM_FLAGS + 0x10)//sandgem
#define FLAG_VISITED_DEWFORD_TOWN                   (SYSTEM_FLAGS + 0x11)//jubilife
#define FLAG_VISITED_LAVARIDGE_TOWN                 (SYSTEM_FLAGS + 0x12)//oreburgh
#define FLAG_VISITED_FALLARBOR_TOWN                 (SYSTEM_FLAGS + 0x13)//floaroma
#define FLAG_VISITED_VERDANTURF_TOWN                (SYSTEM_FLAGS + 0x14)//eterna
#define FLAG_VISITED_PACIFIDLOG_TOWN                (SYSTEM_FLAGS + 0x15)//hearthome
#define FLAG_VISITED_PETALBURG_CITY                 (SYSTEM_FLAGS + 0x16)//solaceon
#define FLAG_VISITED_SLATEPORT_CITY                 (SYSTEM_FLAGS + 0x17)//veilstone
#define FLAG_VISITED_MAUVILLE_CITY                  (SYSTEM_FLAGS + 0x18)//pastoria
#define FLAG_VISITED_RUSTBORO_CITY                  (SYSTEM_FLAGS + 0x19)//celestic
#define FLAG_VISITED_FORTREE_CITY                   (SYSTEM_FLAGS + 0x1A)//canalave
#define FLAG_VISITED_LILYCOVE_CITY                  (SYSTEM_FLAGS + 0x1B)//snowpoint
#define FLAG_VISITED_MOSSDEEP_CITY                  (SYSTEM_FLAGS + 0x1C)//sunyshore
#define FLAG_VISITED_SOOTOPOLIS_CITY                (SYSTEM_FLAGS + 0x1D)//pokemon league
