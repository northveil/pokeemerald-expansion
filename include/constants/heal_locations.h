...
enum {
    ...
    HEAL_LOCATION_ETERNA_CITY,
    HEAL_LOCATION_FLOAROMA_TOWN,
    HEAL_LOCATION_JUBILIFE_CITY,
    HEAL_LOCATION_OREBURGH_CITY,
    HEAL_LOCATION_SANDGEM_TOWN,
    HEAL_LOCATION_TWINLEAF_TOWN,
    HEAL_LOCATION_CELESTIC_TOWN,
    HEAL_LOCATION_HEARTHOME_CITY,
    HEAL_LOCATION_SOLACEON_TOWN,
    HEAL_LOCATION_VALOR_LAKEFRONT,
    HEAL_LOCATION_VEILSTONE_CITY,
    HEAL_LOCATION_PASTORIA_CITY,
    HEAL_LOCATION_CANALAVE_CITY,
    NUM_HEAL_LOCATIONS
};
